// require('env2')('.env'); // optionally store
...
module.exports = {
  src_folders: [
    'src/tests/e2e', // Where you are storing your Nightwatch e2e tests
  ],
  ...
  test_settings: {
    default: {
      ...
      screenshots: {
        ...
        path: '.src/tests/e2e/screenshots', // save screenshots here
      },
      globals: {
 ...
 * the following code checks for the existence of
 * `selenium.jar` before trying to run our tests.
 */
